...
public partial class SmXlsGroupMapping
{
    ...
    public string? ColItemExternalNo { get; set; }

    public string? ColItemImpa { get; set; }

    public string? ColItemIssa { get; set; }

    public string? CellAttentionRemarks { get; set; }

    public string? CellLesRecordid { get; set; }

    public string? CellLesLinkid { get; set; }

    public string? CellLesMapid { get; set; }

    public string? ColItemUdf3 { get; set; }

    public string? ColItemPacketSize { get; set; }

    public string? CellByrReplyBefDate { get; set; }

    public string? CellSupAccount { get; set; }

    public string? CellUdf1 { get; set; }

    public string? CellUdf2 { get; set; }

    public string? CellUdf3 { get; set; }

    public string? ColItemUdf1 { get; set; }

    public string? ColItemUdf2 { get; set; }

    public string? CellSalesGroup { get; set; }
}
