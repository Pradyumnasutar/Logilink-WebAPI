...
public partial class SmBuyerSupplierLink
{
    ...
    public virtual SmAddress? Buyer { get; set; }

    public virtual ICollection<SmQuotationsVendor> SmQuotationsVendors { get; set; } = new List<SmQuotationsVendor>();

    public virtual SmAddress? Supplier { get; set; }
}
