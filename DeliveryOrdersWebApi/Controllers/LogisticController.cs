...
using SM_EXTERNAL_USERS = LES_USER_ADMINISTRATION_LIB.Model.SM_EXTERNAL_USERS;
using LeSDataMain;
...
using SkiaSharp;
using Shipment = Logistic_Management_Lib.Model.Shipment;
using Microsoft.AspNetCore.Routing;
using System.Xml.Linq;
using System.Web;
using V_COMPANY_DETAILS_DATA = LES_USER_ADMINISTRATION_LIB.Model.V_COMPANY_DETAILS_DATA;
using eSupplier_Lib.Data;

namespace DeliveryOrdersWebApi.Controllers
{
    [Route("api/V1/Logistic")]
    [ApiController]
    [Authorize]
    public class LogisticController : Controller
    {
        ...
        private readonly ESupplierConlashContext _esuppliercontext;
        private readonly IWebHostEnvironment _webHostEnvironment;

        string ModuleName = "";
        public DataRoutine _routine { get; set; }
        LogisticManagementClass routine ;
        public LogisticController(LogisticDbContext dbContext, UserAdminDbContext dbContextAdmin,ESupplierConlashContext eSupplierConlashContext,LogisticManagementClass logisticRoutine, IWebHostEnvironment webHostEnvironment)
        {
            CommonFunction.setLog("before - Logistic Management");
            _dbContext = dbContext;
            _routine = new DataRoutine(_dbContext, dbContextAdmin, eSupplierConlashContext);
            routine = logisticRoutine;
            var configBuilder = new ConfigurationBuilder()
            .SetBasePath(Directory.GetCurrentDirectory())
            .AddJsonFile("AppSettings.json", optional: true, reloadOnChange: true);
            configuration = configBuilder.Build();
            CommonFunction.setLog("after -  Logistic Management");
        ...
        //        CommonFunction.setLog("QueryData DATA : " + QueryData);
        //        
        //        object obj = routine.CallSqlQueryDataMethod(QueryData);
        //        //object ListData = _routine.();
        //        return Ok(obj);
        //    }
        //    catch (Exception ex)
        //    {
        //        CommonFunction.setLog("Error on GetSqlQueryData :" + ex.Message);
        ...
        //        CommonFunction.setLog("SqlDataParmerter DATA : " + getSerializeData(QueryData));
        //        
        //        object obj = routine.CallSqlQueryDataMethodWithParameter(QueryData);
        //        //object ListData = _routine.();
        //        return Ok(obj);
        //    }
        //    catch (Exception ex)
        //    {
        //        CommonFunction.setLog("Error on GetSqlQueryDataWithParameter :" + ex.Message);
        //        return BadRequest(ex.Message);
        //    }
        //    finally
        //    {
        ...
        public IActionResult GetModuleStatus(int Moduleid)
        {
            try
            {
                ...
                object obj = routine.CallGetModuleStatus(Moduleid);
                //object ListData = _routine.();
                return Ok(obj);
            }
            catch (Exception ex)
        ...
        public IActionResult GetDeliveryOrderList(FilterDeliveryOrdersList modal)
        {
            try
            {
                CommonFunction.setLog("=====================================================");
                ...
                object obj = routine.CallGetDeliveryOrderList(modal);
                //object ListData = _routine.();
                return Ok(obj);
            }
            catch (Exception ex)
        ...
        public IActionResult GetShipmentList(FilterShipmentList modal)
        {
            try
            {
                CommonFunction.setLog("=====================================================");
                ...
                object obj = routine.CallGetShipmentList(modal);
        ...
        public IActionResult GetSiteConfigByModuleidAndCompanyid(int Moduleid, int companyid)
        {
            try
            {
                ...
                object obj = routine.CallGetSiteConfigByModuleidAndCompanyid(Moduleid, companyid);
                //object ListData = _routine.();
                return Ok(obj);
            }
            catch (Exception ex)
        ...
        #region Delivery Orders Details

        [HttpPost]
        [Route("GetDeliveryOrdersInfo")]
        public IActionResult GetDeliveryOrdersInfo(int DeliveryOrderid, int Companyid)
        {
            try
            {
                CommonFunction.setLog("=====================================================");
                CommonFunction.setLog("GetDeliveryOrdersInfo Process started for DeliveryOrderid " + DeliveryOrderid + " and companyid " + Companyid);
                
                object obj = routine.CallGetVDeliveryOrdersInfo_By_Id(DeliveryOrderid, Companyid);
                //object ListData = _routine.();
                return Ok(obj);
            }
            catch (Exception ex)
            {
                CommonFunction.setLog("Error on GetDeliveryOrdersInfo :" + ex.Message);
                return BadRequest(ex.Message);
            }
            finally
            {
                CommonFunction.setLog("GetDeliveryOrdersInfo function stopped successfully.");
            }
        }
        ...
        public IActionResult GetDeliveryOrdersAddressByDeliveryOrderId(int DeliveryOrderid)
        {
            try
            {
                ...
                object obj = routine.CallGetVDeliveryOrdersAddressEpodByDeliveryOrderId(DeliveryOrderid);
                //object ListData = _routine.();
                return Ok(obj);
            }
            catch (Exception ex)
        ...
        public IActionResult GetVDeliveryOrderLines(int DeliveryOrderid)
        {
            try
            {
                ...
                object obj = routine.CallGetVDeliveryOrderLinesByDeliveryOrderId(DeliveryOrderid);
                //object ListData = _routine.();
                return Ok(obj);
            }
            catch (Exception ex)
        ...
        public IActionResult GetDeliveryOrderDocumentsByDeliveryOrderId(int DeliveryOrderid)
        {
            try
            {
                ...
                object obj = routine.CallGetDeliveryOrderDocumentsByDeliveryOrderId(DeliveryOrderid);
                //object ListData = _routine.();
                return Ok(obj);
            }
            catch (Exception ex)
        ...
        public IActionResult PushDeliveryOrders(CreateDeliveryOrderModal _details)
        {
            try
            {
                ...
                SM_ADDRESS _addCompany = routine.CallGetSmAddressByCode(_details.companycode);
                if (_addCompany != null && _addCompany.addr_type.ToLower() == "supplier")
                {
                    ...
                    if (_company != null)
                    {
                        ...
                        obj = routine.CallPushDeliveryOrders(_details);
                    }
                    else
                    {
        ...
        public IActionResult CreateDeliveryOrderDocument(Delivery_Order_Documents _document)
        {
            try
            {
                ...
                object obj = routine.CallAddDeliveryOrderAttachment(_document);
                //object ListData = _routine.();
                return Ok(obj);
            }
            catch (Exception ex)
        ...
        public IActionResult RemoveDeliveryOrderDocument(Remove_Delivery_Order_Documents _document)
        {
            try
            {
                ...
                object obj = routine.CallRemoveDeliveryOrderAttachment(_document);
                //object ListData = _routine.();
                return Ok(obj);
            }
            catch (Exception ex)
        ...
        public IActionResult UpdateEpodDeliveryOrderLines(Update_EPOD_DeliveryOrderItems _itemdata)
        {
            try
            {
                ...
                object obj = routine.CallUpdateEpodDeliveryOrderLines(_itemdata);
                //object ListData = _routine.();
                return Ok(obj);
            }
            catch (Exception ex)
        ...
        public IActionResult UpdateAssignShipmentToDeliveryOrder(AssignDeliverOrder _orderdata)
        {
            try
            {
                ...
                object obj = routine.CallUpdateAssignShipmenttoDeliveryOrder(_orderdata);
                //object ListData = _routine.();
                return Ok(obj);
            }
            catch (Exception ex)
        ...
        public IActionResult UpdateUnAssignShipmentToDeliveryOrder(AssignDeliverOrder _orderdata)
        {
            try
            {
                ...
                object obj = routine.CallUpdateUnAssignShipmenttoDeliveryOrder(_orderdata);
                //object ListData = _routine.();
                return Ok(obj);
            }
            catch (Exception ex)
        ...
        public IActionResult GetEPODDDeliveryOrderInfoLinesByDeliveryOrderId(int deliveryOrderId)
        {
            try
            {
                ...
                object obj = routine.CallGetEPODDeliveryOrderLinesByDeliveryOrderId(deliveryOrderId);
                return Ok(obj);
            }
            catch (Exception ex)
            {
        ...
        public IActionResult GetDeliveryOrdersDropDownByCompanyIdandCustomerid(int companyid, int customerid)
        {
            try
            {
                ...
                object obj = routine.CallGetDeliveryOrdersDropDownByCompanyIdandCustomerid(companyid, customerid);
                return Ok(obj);
            }
            catch (Exception ex)
            {
        ...
        public IActionResult GetDeliveryOrdersDropDownByVerification(DeliveryOrdersDropDownVerification modal)
        {
            try
            {
                ...
                object obj = routine.CallGetDeliveryOrdersDropDownByVerification(modal);
                return Ok(obj);
            }
            catch (Exception ex)
            {
        ...
        public IActionResult UploadDeliveryOrderDocument(AttachDocumentsDataModal _document)
        {
            try
            {
                ...
                object obj = routine.CallCreateDeliveryOrderAttachmentDetails(_document);
                //object ListData = _routine.();
                return Ok(obj);
            }
            catch (Exception ex)
        ...
        public IActionResult DownloadDeliveryOrderDocument(AttachDocumentsDataModal _document)
        {
            ...
            try
            {
                ...
                responseMessage objData = (responseMessage)routine.CallDownloadDeliveryOrderAttachmentDetails(_document);
                if (objData != null)
                {
        ...
        [HttpPost]
        [Route("GetCustomerInfoList")]
        public IActionResult GetCustomerInfoList(int companyid)
        {
            try
            {
                CommonFunction.setLog("=====================================================");
                ...
                object obj = routine.CallGetAllCustomerDetailsByCompanyId(companyid);
                //object ListData = _routine.();
                return Ok(obj);
            }
            catch (Exception ex)
        ...
        public IActionResult GetCustomerInfoListbyCustomerId(int companyid)
        {
            try
            {
                ...
                object obj = routine.CallGetAllCustomerDetailsByCustomerId(addrId.addressid);
        ...
        public IActionResult GetShipmentInfo(int Shipmentid, int Companyid)
        {
            try
            {
                ...
                object obj = routine.CallGetShipmentDetailsById(Shipmentid, Companyid);
                //object ListData = _routine.();
                return Ok(obj);
            }
            catch (Exception ex)
        ...
        public IActionResult GetPrintShipmentInfo(int Shipmentid, int Companyid)
        {
            try
            {
                ...
                object obj = routine.CallGetPrintShipmentDetailsById(Shipmentid, Companyid);
                //object ListData = _routine.();
                return Ok(obj);
            }
            catch (Exception ex)
        ...
        public IActionResult GetVShipmentTripPlan(int Shipmentid)
        {
            try
            {
                ...
                object obj = routine.CallGetVShipmentTripPlanByShipmentId(Shipmentid);
                //object ListData = _routine.();
                return Ok(obj);
            }
            catch (Exception ex)
        ...
        public IActionResult GetDeliveryOrderListByShipmentId(int ShipmentId)
        {
            try
            {
                ...
                object obj = routine.CallGetVShipmentDeliveryOrdersByShipmentId(ShipmentId);
                //object ListData = _routine.();
                return Ok(obj);
            }
            catch (Exception ex)
        ...
        public IActionResult GetShipmentDocumentByShipmentId(int ShipmentId)
        {
            try
            {
                ...
                object obj = routine.CallGetShipmentDocumentByShipmentId(ShipmentId);
                //object ListData = _routine.();
                return Ok(obj);
            }
            catch (Exception ex)
        ...
        public IActionResult CreateShipmentDetails(CreateShipmentOrderModal shipmentData)
        {
            try
            {
                ...
                object obj = routine.CallCreateOutboundShipment(shipmentData);
                //object ListData = _routine.();
                return Ok(obj);
            }
            catch (Exception ex)
        ...
        public IActionResult UpdateShipmentDetails(UpdateShipmentOrderModal shipmentData)
        {
            try
            {
                ...
                object obj = routine.CallUpdateOutboundShipment(shipmentData);
                //object ListData = _routine.();
                return Ok(obj);
            }
            catch (Exception ex)
        ...
        public IActionResult CreateShipmentDocument(Shipment_Documents _document)
        {
            try
            {
                ...
                object obj = routine.CallAddShipmentAttachment(_document);
                //object ListData = _routine.();
                return Ok(obj);
            }
            catch (Exception ex)
        ...
        public IActionResult RemoveShipmentDocument(Remove_Shipment_Documents _document)
        {
            try
            {
                ...
                object obj = routine.CallRemoveShipmentAttachment(_document);
                //object ListData = _routine.();
                return Ok(obj);
            }
            catch (Exception ex)
        ...
        public IActionResult UpdateEPODShipmentDetails(EPOD_ShipmentDetails _document)
        {
            try
            {
                ...
                object obj = routine.CallUpdateEPODShipmentDetails(_document);
                //object ListData = _routine.();
                return Ok(obj);
            }
            catch (Exception ex)
        ...
        public IActionResult GetShipmentDropDownByCompanyId(int companyid)
        {
            try
            {
                ...
                object obj = routine.CallGetShipmentDropDownByCompanyId(companyid);
                return Ok(obj);
            }
            catch (Exception ex)
            {
        ...
        public IActionResult GetNewShipmentWithDOList(deliveryOrderListModal details)
        {
            try
            {
                ...
                object obj = routine.CallGetNewShipmentWithDOList(details);
                //object ListData = _routine.();
                return Ok(obj);
            }
            catch (Exception ex)
        ...
        public IActionResult UploadShipmentDocument(AttachDocumentsDataModal _document)
        {
            try
            {
                ...
                object obj = routine.CallCreateShipmentAttachmentDetails(_document);
                //object ListData = _routine.();
                return Ok(obj);
            }
            catch (Exception ex)
        ...
        public IActionResult DownloadShipmentDocument(AttachDocumentsDataModal _document)
        {
            ...
            try
            {
                ...
                responseMessage objFile = (responseMessage)routine.CallDownloadShipmentAttachmentDetails(_document);
        ...
        public IActionResult GetAnchorageList()
        {
            try
            {
                ...
                object obj = routine.CallGetAllAnchorage();
                //object ListData = _routine.();
                return Ok(obj);
            }
            catch (Exception ex)
        ...
        public IActionResult AddAnchorage(Mast_Anchorage _details)
        {
            ...
            try
            {
                ...
                if (_details.AnchorageDescription != "" && _details.AnchorageCode != "")
                {
                    ...
                    List<Mast_Anchorage> _lstAnchorage = (List<Mast_Anchorage>)routine.CallGetAllAnchorage();
                    ...
                    {
                        object val = routine.CallAddAnchorage(_details);
                        //object ListData = _routine.();
        ...
        public IActionResult UpdateAnchorage(Update_Anchorage _details)
        {
            ...
            try
            {
                ...
                if (_details.AnchorageDescription != "" && _details.AnchorageCode != "")
                {
                    ...
                    {
                        object val = routine.CallUpdateAnchorage(_details);
                        //object ListData = _routine.();
                        if (convert.ToInt(val) > 0)
                        {
                            obj.status = "SUCCESS";
        ...
        public IActionResult GetGoodsReturnReasonsList()
        {
            try
            {
                ...
                object obj = routine.CallGetAllGoodsReturnReasons();
                //object ListData = _routine.();
                return Ok(obj);
            }
            catch (Exception ex)
        ...
        public IActionResult AddGoodsReturnReasons(Mast_Goods_Return_Reasons _details)
        {
            ...
            try
            {
                ...
                {
                    List<Mast_Goods_Return_Reasons> List = (List<Mast_Goods_Return_Reasons>)routine.CallGetAllGoodsReturnReasons();
                    ...
                    {
                        object val = routine.CallAddGoodsReturnReasons(_details);
                        if (convert.ToInt(val) > 0)
                        {
                            obj.status = "SUCCESS";
                            obj.isSuccess = true;
        ...
        public IActionResult UpdateGoodsReturnReasons(Update_Goods_Return_Reasons _details)
        {
            ...
            try
            {
                ...
                if (_details.GrnReasonCode != "" && _details.GrnReasonDescription != "")
                {
                    ...
                    {
                        object val = routine.CallUpdateGoodsReturnReasons(_details);
                        if (convert.ToInt(val) > 0)
                        {
                            obj.status = "SUCCESS";
                            obj.isSuccess = true;
        ...
        public IActionResult GetTransportTypeList()
        {
            try
            {
                ...
                object obj = routine.CallGetAllTransportType();
                //object ListData = _routine.();
                return Ok(obj);
            }
            catch (Exception ex)
        ...
        public IActionResult AddTransportType(MAST_TRANSPORT_TYPE _details)
        {
            ...
            try
            {
                ...
                {
                    List<MAST_TRANSPORT_TYPE> List = (List<MAST_TRANSPORT_TYPE>)routine.CallGetAllTransportType();
                    ...
                    {
                        object val = routine.CallAddTransportType(_details);
                        //object ListData = _routine.();
                        if (convert.ToInt(val) > 0)
                        {
                            obj.status = "SUCCESS";
        ...
        public IActionResult UpdateTransportType(Update_Transport_Type _details)
        {
            ...
            try
            {
                ...
                if (_details.transport_type_code != "" && _details.transport_type_description != "")
                {
                    ...
                    {
                        object val = routine.CallUpdateTransportType(_details);
                        //object ListData = _routine.();
                        if (convert.ToInt(val) > 0)
                        {
                            obj.status = "SUCCESS";
        ...
        public IActionResult GetVesselList()
        {
            try
            {
                ...
                object obj = routine.CallGetVesselDetails();
                //object ListData = _routine.();
                return Ok(obj);
            }
            catch (Exception ex)
        ...
        public IActionResult AddVessels(Mast_Vessel _details)
        {
            ...
            try
            {
                ...
                {
                    List<Mast_Vessel> List = (List<Mast_Vessel>)routine.CallGetAllVessels();
                    ...
                    {
                        object val = routine.CallAddVessels(_details);
                        //object ListData = _routine.();
                        if (convert.ToInt(val) > 0)
                        {
                            obj.status = "SUCCESS";
            ...
            catch (Exception ex)
            {
                ...
                obj.status = "FAIL";
                obj.isSuccess = false;
                obj.message = "Error on Add Vessel :" + ex.Message;
                LeSDataMain.LeSDM.SetAuditLogFile(ModuleName, "ERROR", "", "Error on Add Vessel :" + ex.Message, "", "", "", "");
            }
            finally
            {
                CommonFunction.setLog("AddVessel function stopped successfully.");
            }
            return Ok(obj);
        }
        ...
        public IActionResult UpdateVessels(Update_Vessels _details)
        {
            ...
            try
            {
                ...
                {
                    List<Mast_Vessel> List = (List<Mast_Vessel>)routine.CallGetAllVessels();
                    if ((List.FirstOrDefault(x => x.VesselId == _details.VesselId)) != null)
                    {
                        throw new Exception("Vessel Code '" + _details.VesselCode + "' already present.");
                    }
                    else
                    {
                        object val = routine.CallUpdateVessels(_details);
                        //object ListData = _routine.();
                        if (convert.ToInt(val) > 0)
                        {
                            obj.status = "SUCCESS";
            ...
            {
                CommonFunction.setLog("Error on UpdateVessel :" + ex.Message);
                obj.status = "FAIL";
                obj.isSuccess = false;
                obj.message = "Error on Update Vessel :" + ex.Message;
                LeSDataMain.LeSDM.SetAuditLogFile(ModuleName, "ERROR", "", "Error on Update Vessel :" + ex.Message, "", "", "", "");
            }
            finally
            {
                CommonFunction.setLog("UpdateVessel function stopped successfully.");
            }
            return Ok(obj);
        }
        ...
        public IActionResult CallGetCustomerListDetailsByCompanyId(int companyid)
        {
            try
            {
                ...
                object obj = routine.CallGetCustomerListDetailsByCompanyId(companyid);
                //object ListData = _routine.();
                return Ok(obj);
            }
            catch (Exception ex)
        ...
        public IActionResult GenerateQRCode(QRModal contentData)
        {
            try
            {
                ...
                object obj = routine.CallGenerateQRCode(contentData);
                //object ListData = _routine.();
                return Ok(obj);
            }
            catch (Exception ex)
        ...
        //[HttpPost]
        //[Route("GetVesselAuthentication")]
        //public IActionResult GetVesselAuthentication(VesselAuthenticationParameter _paramVal)
        //{
        //	try
        //	{
        //		CommonFunction.setLog("=====================================================");
        //		CommonFunction.setLog("GetVesselAuthentication Process started");
        //		CommonFunction.setLog("VesselAuthenticationParameter DATA : " + getSerializeData(_paramVal));
        //		VesselAuthenticationModalViews _vslAuth = new VesselAuthenticationModalViews();
        //		
        //		UserAdminClass _adminrtn = new UserAdminClass(_dbContextAdmin);

        //		Shipment _shipmentData = (Shipment)routine.CallGetShipmentByShipmentid(_paramVal.shipmentid);
        //		if (_shipmentData != null)
        //		{
        //			V_Shipment_Info _shipmentDetails = (V_Shipment_Info)routine.CallGetShipmentDetailsById(_paramVal.shipmentid, convert.ToInt(_shipmentData.CompanyId));
        ...
        //			{
        //				SM_EXTERNAL_USERS _userdetails = (SM_EXTERNAL_USERS)_adminrtn.CallSmExternalUsersByEmail(_paramVal.useremailid);
        //				if (_userdetails != null)
        //				{
        //					string sPassword = LES_USER_ADMINISTRATION_LIB.GlobalTools.EncodePassword(_paramVal.password);
        //					List<V_COMPANY_DETAILS_DATA> _lstUserCompany = (List<V_COMPANY_DETAILS_DATA>)_adminrtn.CallGetusercompanylinkByUserId(_userdetails.ex_userid);
        ...
        //						if (CompanyData != null)
        //						{
        //							if (convert.ToInt(_shipmentDetails.vessel_id) > 0)
        //							{
        //								if (_userdetails.ex_password == sPassword)
        //								{
        ...
        //										slUserAccess = (List<LES_USER_ADMINISTRATION_LIB.Model.V_APPLICATION_MODULE_ACCESS>)_adminrtn.CallGetVApplicationModuleAccessBycompanyandUseridForEpod(convert.ToInt(_shipmentDetails.companyid), _userdetails.ex_userid);
        //										string userType = "";
        //										if (slUserAccess != null && slUserAccess.Count > 0)
        //										{
        //											userType = slUserAccess[0].UserTypeDescr;

        //										}
        //										if (routine.CallAddEpodAccessLogs(_shipmentDetails.shipmentid, _userdetails.ex_userid, _paramVal.useremailid, _paramVal.latitude, _paramVal.longitude, _userdetails.ex_username, "", userType))
        //										{
        //											CommonFunction.setLog("EPOD Access log set successfully for User Email : " + _paramVal.useremailid);
        //											_vslAuth.userid = convert.ToInt(_userdetails.ex_userid);
        //											_vslAuth.username = convert.ToString(_userdetails.ex_username);
        //											_vslAuth.usercode = convert.ToString(_userdetails.ex_usercode);
        //											_vslAuth.useremailid = convert.ToString(_userdetails.ex_emailid);
        //											_vslAuth.defaultcompanyid = convert.ToString(_userdetails.companyid);
        ...
        //							else
        //							{
        //								throw new Exception("Vessel details no found for the Shipment.");
        //							}
        //						}
        //						else
        //						{
        ...
        //				else
        //				{
        //					throw new Exception("User details is Invalid");
        //				}
        //			}
        //			else
        //			{
        ...
        //	catch (Exception ex)
        //	{
        //		CommonFunction.setLog("Error on GetVesselAuthentication :" + ex.Message);
        //		return BadRequest(ex.Message);
        //	}
        //	finally
        //	{
        //		CommonFunction.setLog("GetVesselAuthentication function stopped successfully.");
        //	}
        //}
                        ...
                        if (_lstUserCompany.Count() > 0)
                        {
                            ...
                            if (CompanyData != null)
                            {
                                if (_paramVal.latitude != "" && _paramVal.longitude != "")
                                {
                                    ...
                                    {
                                        List<LES_USER_ADMINISTRATION_LIB.Model.V_APPLICATION_MODULE_ACCESS> slUserAccess = null;
                                        bool CheckLoginMail = routine.CallCheckEpodAccessLogs(_paramVal.shipmentid, _paramVal.useremailid);
                                        ...
                                        if (routine.CallAddEpodAccessLogs(_shipmentDetails.shipmentid, convert.ToInt(_paramVal.userid), _paramVal.useremailid.ToLower(), _paramVal.latitude, _paramVal.longitude, _paramVal.crewname.ToUpper(), _paramVal.vesselimo, _paramVal.role.ToUpper()))
                                        {
                                            CommonFunction.setLog("EPOD Access log set successfully for User Email : " + _paramVal.useremailid);
        ...
        public IActionResult GetVerifiedDOList(ShipmentData shipmentData)
        {
            try
            {
                ...
                object obj = routine.CallGetVerifiedDOList(shipmentData.shipmentid, shipmentData.companyid);
                //object ListData = _routine.();
                return Ok(obj);
            }
            catch (Exception ex)
        ...
        private COMPANY_INFO_DATA GetCompanyAddressDetails(V_COMPANY_DETAILS_DATA _data)
        {
            ...
            COMPANY_INFO_DATA _CompData = new COMPANY_INFO_DATA();
            SM_ADDRESS _address = (SM_ADDRESS)routine.CallSmAddressById(convert.ToInt(_data.AddressId));
            if (_address != null)
            {
        ...
        public IActionResult EpodUpdateShippedStatus(UpdateEpodStatusModal modal)
        {
            try
            {
                ...
                object obj = routine.CallEpodUpdateShippedStatus(modal.shipmentid, modal.userid, modal.latitude, modal.longitude, modal.emailid, modal.username, modal.vesselimo, modal.role);
                //object ListData = _routine.();
                return Ok(obj);
            }
            catch (Exception ex)
        ...
        public IActionResult EpodUpdateVerificationStatus(UpdateEpodStatusModal modal)
        {
            try
            {
                ...
                object obj = routine.CallEpodUpdateVerificationStatus(modal.shipmentid, modal.userid, modal.latitude, modal.longitude, modal.emailid, modal.username, modal.vesselimo, modal.role);
                //object ListData = _routine.();
                return Ok(obj);
            }
            catch (Exception ex)
        ...
        public IActionResult EpodUpdateConfirmedStatus(UpdateEpodStatusModal modal)
        {
            try
            {
                ...
                object obj = routine.CallEpodUpdateConfirmedStatus(modal.shipmentid, modal.userid, modal.latitude, modal.longitude, modal.emailid, modal.username, modal.vesselimo, modal.role);
                //object ListData = _routine.();
                return Ok(obj);
            }
            catch (Exception ex)
        ...
        [HttpPost]
        [Route("GetEpodShipmentList")]
        public IActionResult GetEpodShipmentList(FilterShipmentList modal)
        {
            try
            {
                CommonFunction.setLog("=====================================================");
                ...
                object obj = routine.CallGetEPODShipmentList(modal);
                //object ListData = _routine.();
                return Ok(obj);
            }
            catch (Exception ex)
        ...
        public IActionResult GetPrintGRNReport(fData _data)
        {
            ...
            try
            {
                ...
                if (_lstUserCompany.Count > 0)
                {
                    ...
                    {
                        _PrintData = (PrintGoodsReturnReportModal)routine.CallPrintGoodsReturnReport(_data.shipmentid, _data.companyid);
        ...
        public IActionResult GetLogisticExportData()
        {
            ...
            try
            {
                ...
                _exportData = (ExportDataModal)routine.CallLogisticExportData();
        ...
        public IActionResult UploadShipmentGRNReport(AttachDocumentsDataModal _document)
        {
            try
            {
                ...
                object obj = routine.CallUpdateShipmentGRNAttachmentDetails(_document);
                //object ListData = _routine.();
                return Ok(obj);
            }
            catch (Exception ex)
        ...
        public IActionResult DownloadShipmentGRNReport(AttachDocumentsDataModal _document)
        {
            ...
            try
            {
                ...
                responseMessage objData = (responseMessage)routine.CallDownloadGRNShipmentAttachmentDetails(_document);
                if (objData != null)
                {
                    obj = objData.data;
                }
        ...
        public IActionResult UpdateInitialReceiptMarker(UpdateInitialExportedMarker _data)
        {
            ...
            try
            {
                ...
                if (convert.ToInt(_data.companyid) > 0)
                {
                    ...
                    responseMessage objData = (responseMessage)routine.CallUpdateInitialReceiptMarker(_data);
        ...
        public IActionResult UpdateFinalReceiptMarker(UpdateFinalExportedMarker _data)
        {
            ...
            try
            {
                ...
                if (convert.ToInt(_data.companyid) > 0)
                {
                    ...
                    responseMessage objData = (responseMessage)routine.CallUpdateFinalReceiptMarker(_data);
                    if (objData != null)
                    {
                        obj = objData.data;
                    }
    ...
    internal class VesselAuthenticationModalViews
    {
    ...
    public class LogisticManagementClass : Logistic_Management_Lib.DataRoutine
    {
        private readonly LogisticDbContext _dbContext;
        private readonly ESupplierConlashContext _dbesupplier;
        public LogisticManagementClass(LogisticDbContext dbContext, UserAdminDbContext userAdminDb, ESupplierConlashContext dbesupplier)
        : base(dbContext, userAdminDb, dbesupplier)
        {
        ...
        //{
        //    return GetSqlQueryDataParameters(Querydata.SqlQuery, Querydata.Parmerter);
        //}
        ...
        public object CallGetVesselDetails()
        {
            return GetVesselDetails();
        }
